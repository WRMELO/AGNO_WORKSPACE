...
- local_root_selected: `[LEGACY_ROOT]`
...
Foi detectado repositorio local operacional fora de `_wt` em `[LEGACY_ROOT]`; ele foi selecionado como ponto unico de operacao.
...
Criado em: `[LEGACY_ROOT]_exports/20260216/`
- `[LEGACY_ROOT]_exports/20260216/bundle_manifest.json`
- `[LEGACY_ROOT]_exports/20260216/bundle_manifest.md`

## Modo operacional LOCAL_ROOT

Ajuste minimo aplicado: orientacao explicita no indice humano para executar proximas tasks em `[LEGACY_ROOT]`.
