...
| T037 | M3 Canonical Engine Baseline | Strategy | DONE | T037: Execucao formal do motor M3 canonico. Artefatos em `src/data_engine/features/` e `src/data_engine/portfolio/`. Baseline: equity_final=R$160.023, CAGR=6.43%, MDD=-49.79%, Sharpe=0.43, 583 trades, custo_total=R$1.451. Audit PASS. | 2026-02-27T07:07:00Z |
